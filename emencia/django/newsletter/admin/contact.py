...
class ContactAdmin(admin.ModelAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'apps', 'tags', 'tester', 'subscriber',
    ...
    search_fields = ('email', 'first_name', 'last_name', 'apps', 'tags')
    fieldsets = ((None, {'fields': ('email', 'first_name', 'last_name', 'apps')}),
                 (None, {'fields': ('tags',)}),
